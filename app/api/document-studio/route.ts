...
export async function POST(request:Request){
  ...
  try{
    ...
    result.readiness=readiness;result.mode=input.mode;result.templateId=input.templateId;result.country=input.country;result.region=input.region;result.outputLanguage=input.outputLanguage;
