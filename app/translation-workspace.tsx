...
type Copy = {
  title: string; intro: string; target: string; sourceAuto: string; upload: string; paste: string; drop: string; release: string; orChoose: string;
