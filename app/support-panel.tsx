      ...
      <div className="support-layout">
        ...
        <div className="support-main">
          ...
          {selectedId === null ? <form className="support-compose" onSubmit={(event) => { event.preventDefault(); void apply("create"); }}>
            ...
            <label className="support-file-input">{t.attachments}<input type="file" accept="image/jpeg,image/png,image/webp" multiple disabled={busy} onChange={(event) => chooseAttachments(Array.from(event.target.files ?? []), "new")} /><small>{t.attachmentHint}</small></label>
