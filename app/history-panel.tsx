...
const copy = {
  ru: { title: "История разборов", intro: "Здесь хранятся только результаты анализа — не исходные файлы и не вставленный текст.", close: "Закрыть историю", loading: "Загружаем историю…", empty: "Сохранённых разборов пока нет.", open: "Открыть", remove: "Удалить", confirm: "Удалить этот разбор без возможности восстановления?", error: "Не удалось загрузить историю. Попробуйте ещё раз.", deleteError: "Не удалось удалить разбор.", file: "Файл", text: "Текст" },
  lv: { title: "Analīžu vēsture", intro: "Tiek saglabāti tikai analīzes rezultāti — ne sākotnējie faili vai ievadītais teksts.", close: "Aizvērt vēsturi", loading: "Ielādējam vēsturi…", empty: "Saglabātu analīžu vēl nav.", open: "Atvērt", remove: "Dzēst", confirm: "Neatgriezeniski dzēst šo analīzi?", error: "Neizdevās ielādēt vēsturi. Mēģiniet vēlreiz.", deleteError: "Neizdevās dzēst analīzi.", file: "Fails", text: "Teksts" },
  en: { title: "Analysis history", intro: "Only analysis results are stored — never the original files or pasted text.", close: "Close history", loading: "Loading history…", empty: "You have no saved analyses yet.", open: "Open", remove: "Delete", confirm: "Permanently delete this analysis?", error: "We could not load your history. Please try again.", deleteError: "We could not delete this analysis.", file: "File", text: "Text" },
} as const;
